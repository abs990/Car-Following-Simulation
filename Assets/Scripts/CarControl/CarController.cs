...
namespace UnityCar
{
    ...
    {
        [SerializeField] private float mass = SimulationSingleton.CAR_MASS;
        [SerializeField] private Vector3 coG = SimulationSingleton.CENTRE_OF_GRAVITY;
        [SerializeField] private Vector3 inertiaTensor = SimulationSingleton.INERTIA_TENSOR;
